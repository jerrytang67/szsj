...
import { TenantAvailabilityState } from "@/api/appService";
...
export default class extends Vue {
   ...
   private switchTenant(e: any) {
      if (e) {
         api.account
            .isTenantAvailable({ body: { tenancyName: e } })
            .then((res) => {
               if (res.state === TenantAvailabilityState.Available) {
                  AppModule.SetTenantId(res.tenantId!);
                  this.$message({
                     type: "success",
                     message: "切换成功",
                  });
