...
import CraftsmanRecommendDetail from "@/views/craftsman/components/CraftsmanRecommendDetail.vue";
import { DefaultElementTable } from "@/lib/ElementTableView";
const auditName = "Audit_LaborUnion_Craftsman_Recommend";

@Component({ components: { CraftsmanRecommendDetail } })
export default class CraftsmanRecommendAuditPanel extends AuditPanelView {
   @Ref() detail!: CraftsmanRecommendDetail;

   auditName = auditName;

   apiController = api.craftsmanRecommend;
   ...
   // 查看详情
   handleView(row: CraftsmanRecommendDto) {
