...
namespace TtWork.ProjectName.Web.Host.Startup
{
    public static class AuthConfigurer
    {
        ...
        private static Task QueryStringTokenResolver(MessageReceivedContext context)
        {
            ...
            var ouId = context.HttpContext.Request.Headers["Abp.OrganizationUnitId"].FirstOrDefault();
            if (ouId != null)
            {
                var claims = new List<Claim>
                {
                    new("Abp.OrganizationUnitId", ouId)
                };
            ...
            if (context.HttpContext.Request.Path.Value != null && context.HttpContext.Request.Path.Value.StartsWith("/signalr"))
            {
            ...
            if (context.HttpContext.Request.Path.Value != null && context.HttpContext.Request.Path.Value.Contains("/Chat/GetUploadedObject"))
            {
