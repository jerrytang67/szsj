        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PickupWay = table.Column<int>(type: "int", nullable: false),
                    Price = table.Column<int>(type: "int", nullable: true),
                    MaxDrawTimes = table.Column<int>(type: "int", nullable: false),
                    MaxWinTimes = table.Column<int>(type: "int", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Address_UserName = table.Column<string>(type: "nvarchar(64)", maxLength: 64, nullable: true),
                    Address_PostalCode = table.Column<string>(type: "nvarchar(64)", maxLength: 64, nullable: true),
                    Address_ProvinceName = table.Column<string>(type: "nvarchar(64)", maxLength: 64, nullable: true),
                    Address_CityName = table.Column<string>(type: "nvarchar(64)", maxLength: 64, nullable: true),
                    Address_CountyName = table.Column<string>(type: "nvarchar(64)", maxLength: 64, nullable: true),
                    Address_DetailInfo = table.Column<string>(type: "nvarchar(64)", maxLength: 64, nullable: true),
                    Address_NationalCode = table.Column<string>(type: "nvarchar(64)", maxLength: 64, nullable: true),
                    Address_TelNumber = table.Column<string>(type: "nvarchar(64)", maxLength: 64, nullable: true),
                    CreationTime = table.Column<DateTime>(type: "datetime2", nullable: false),
                    CreatorUserId = table.Column<long>(type: "bigint", nullable: true)
                },
                constraints: table =>
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PickupWay = table.Column<int>(type: "int", nullable: true),
                    LuckDrawId = table.Column<long>(type: "bigint", nullable: false),
                    TenantId = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
